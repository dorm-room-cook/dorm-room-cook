...
Meteor-application-template-react is a sample Meteor 1.9 application that illustrates:
  ...
  * [alanning:roles](https://github.com/alanning/meteor-roles) to implement a special "ListRecipes" user.
...
#### Landing (after Login) page, non-ListRecipes user
...
#### Landing (after Login), ListRecipes user
...
#### ListRecipes page (list all users stuff)

To provide a simple example of a "super power" for ListRecipes users, the ListRecipes page lists all of the Stuff by all of the users:
