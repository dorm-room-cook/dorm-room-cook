...
import { AutoField, AutoForm, TextField, LongTextField, SubmitField, ErrorsField, NumField } from 'uniforms-semantic';
...
class MyRecipes extends Component {
  ...
  submit(data, formRef) {
    const {
      name, image, description, time, ingredients, type, tools, servings, instructions,
      source, notes,
    } = data;
    ...
    Recipes.insert({
          name, image, description, time, items, ingredients, type, tools, servings, instructions,
